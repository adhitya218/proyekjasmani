          ...
          <div class="box box-primary" style="width:94%;">
            ...
            <?php } ?>
              ...
              <!-- <div class="box-body">
                ...
                <div class="form-group" style="margin-bottom:40px;">
                  <label for="gender" style="margin-left:220px;display:inline;">Gender</label>
                  <select class="form-control" name="gender" style="margin-left:75px;width:20%;display:inline;">
                    <option value="">-- Pilih --</option>
                ...
                <div class="form-group" style="display:inline-block;">
                  ...
                  <input type="text" name="nama" style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="nama" placeholder="Kode Barang">
                </div>
                <div class="form-group" style="display:inline-block;">
                  <label for="no_ak" style="width:73%;">No Ak</label>
                  <input type="text" name="no_ak" style="width:90%;margin-right: 67px;" class="form-control" id="no_ak" placeholder="Nama Barang">
              </div>
              
                <div class="form-group" style="display:inline-block;">
                  <label for="tingkat" style="width:73%;">Tingkat</label>
