    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?= base_url('admin/tabel_barangmasuk')?>"><i class="fa fa-circle-o"></i> Tabel Siswa</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Update Data Siswa</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('admin/proses_siswa_update')?>" role="form" method="post">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group" style="display:inline-block;">
                  <label for="nama" style="width:87%;margin-left: 12px;">Nama</label>
                  <input type="text" name="nama" required style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="nama" value="<?=$d->nama?>">
                </div>
                <div class="form-group" style="display:inline-block;">
                  <label for="no_ak" style="width:73%;">No AK</label>
                  <input type="text" name="no_ak" required style="width:90%;margin-right: 67px;" class="form-control" id="no_ak" value="<?=$d->no_ak?>">
              </div>
              <div class="form-group" style="display:inline-block;">
                  <label for="tingkat" style="width:73%;">Satuan</label>
                  <select class="form-control" name="tingkat" style="width:110%;margin-right: 18px;">
                    <?php foreach($list_tingkatan as $s){?>
                      <?php if($d->tingkat == $s->nama_tingkatan){?>
                    <option value="<?=$d->tingkat?>" selected=""><?=$d->tingkat?></option>
                    <?php }else{?>
                    <option value="<?=$s->kode_tingkatan?>"><?=$s->nama_tingkatan?></option>
                      <?php } ?>
                      <?php } ?>
                  </select>
              </div>
              <!-- <div class="form-group" style="display:inline-block;">
                <label for="jumlah" style="width:73%;margin-left:33px;">Kelas</label>
                <input type="number" name="jumlah" style="width:41%;margin-left:34px;margin-right:18px;" class="form-control" id="jumlah" value="<?=$d->kelas?>">
            </div> -->
            <?php } ?>
              <!-- /.box-body -->
