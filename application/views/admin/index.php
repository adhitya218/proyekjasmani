    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('admin/tabel_siswa') ?>"><i class="fa fa-circle-o"></i> Tabel Siswa</a></li>
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="inner">
            ...
            <a href="<?=base_url('admin/tabel_siswa')?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
