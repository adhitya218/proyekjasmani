          ...
          <div class="box box-primary" style="width:94%;">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group" style="display:block;">
                  <label for="no_identitas" style="width:87%;margin-left: 0px;">No Identitas</label>
                  <input type="text" name="no_identitas" style="width: 30%;margin-right: 67px;margin-left: 0px;" class="form-control" id="no_identitas" placeholder="No Identitas">
                </div>
                <div class="form-group" style="display:block;">
              ...
              <div class="form-group" style="display:block;">
                ...
                <select class="form-control" name="role" style="width:11%;margin-right: 18px;">
                  ...
                  <option value="0">User Panitia</option>
